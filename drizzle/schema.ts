...
export const albums = sqliteTable(
  ...
  (table) => [index("IFK_AlbumArtistId").on(table.artistId)]
);
...
export const customers = sqliteTable(
  "customers",
  {
    ...
    supportRepId: integer("SupportRepId").references(
      () => employees.employeeId
    ),
  },
  (table) => [index("IFK_CustomerSupportRepId").on(table.supportRepId)]
);
...
export const invoices = sqliteTable(
  ...
  (table) => [index("IFK_InvoiceCustomerId").on(table.customerId)]
);

export const invoiceItems = sqliteTable(
  "invoice_items",
  {
    invoiceLineId: integer("InvoiceLineId")
      .primaryKey({ autoIncrement: true })
      .notNull(),
    invoiceId: integer("InvoiceId")
      .notNull()
